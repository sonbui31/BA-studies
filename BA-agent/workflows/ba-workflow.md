...
2. **Customer Intelligence & Elicitation**
   - Run `../BA-document-rule/core/customer-intelligence-guide.md` for strategic client probing.
   - Extract hidden needs, analyze stakeholder psychology, build Insight Cards.

3. **Initialize Workspace & Brainstorm (o4/GPT-5)**
