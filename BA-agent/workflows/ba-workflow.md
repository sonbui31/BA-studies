---
description: Business Analysis Workflow 2.0 - AI & Data Augmented
---

# BA Workflow Protocol 2.0
...
1. **Project Classification & Metric Identification**
   ...
   - **New 2.0:** Ask user for the "North Star Metric" or "Business Goal".

2. **Initialize Workspace 2.0**
...
3. **Template Selection & Data Planning**
   ...
   - **New 2.0:** Identify data events that need to be tracked for the success metrics.

4. **Document Generation (via @ba-specialist 2.0)**
...
5. **AI-Driven Quality Gate**
   ...
   - **New 2.0:** Self-ask "Does this feature have a way to measure its success?"
